...
const WhatsAppFloat = () => {
    const whatsappUrl = `https://wa.me/message/7IOS6GEQRVSLH1`;
    ...
    return (
        ...
        >
            ...
            <div className="relative bg-gradient-to-br from-green-400 to-green-600 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all">
                <svg
