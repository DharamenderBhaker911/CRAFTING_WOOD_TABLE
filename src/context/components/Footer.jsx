            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-gold to-sage bg-clip-text text-transparent">
                            Suzeraine Epoxy Smith
                        </h3>
                        <p className="text-cream/70 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
                        ...
                        <div className="flex gap-4">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center hover:bg-green-500/30 transition-colors"
                                title="WhatsApp"
                            >
                            ...
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2, y: -3 }}
                                whileTap={{ scale: 0.9 }}
                                className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center hover:bg-pink-500/30 transition-colors"
                                title="Instagram"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2, y: -3 }}
                                whileTap={{ scale: 0.9 }}
                                className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center hover:bg-blue-500/30 transition-colors"
                                title="Facebook"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul className="space-y-2">
                            {quickLinks.map((link) => (
                                <motion.li key={link.path} whileHover={{ x: 5 }}>
                                    <Link to={link.path} className="text-cream/70 hover:text-gold transition-colors text-sm sm:text-base">
                                        {link.name}
                                    </Link>
                                </motion.li>
                            ))}
